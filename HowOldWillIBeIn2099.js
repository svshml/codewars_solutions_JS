...
function  calculateAge(yearBorn, yearAsk) {
  if(yearAsk - yearBorn === 0){
      return  `You were born this very year!`;
  } else if(yearAsk - yearBorn === 1){
    return `You are ${-(yearBorn - yearAsk)} year old.`;
  }  else if(yearBorn - yearAsk === 1){
    return `You will be born in ${-(yearAsk - yearBorn)} year.`;
  } else if(yearAsk - yearBorn < 0){
    return  `You will be born in ${-(yearAsk - yearBorn)} years.`;
  } else 
    return `You are ${yearAsk - yearBorn} years old.`;
}

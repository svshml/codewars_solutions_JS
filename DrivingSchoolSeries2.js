...
For example, if student X has a lesson for 1hr 20 minutes, he will be charged $40 (30+10) for 1 hr 30 mins and if he has a lesson for 5 minutes, 
...
function cost (mins) { 
  let  a = mins - 65
  if ( a <= 0 ) return 30;
  else if (a <= 30) return 40;
  else return Math.ceil(a/30)* 10 + 30;
  }
